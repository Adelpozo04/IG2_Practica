...
void OpeningScene::Update(float dt)
{
    ...
    animationStateDance->addTime(dt);
...
void OpeningScene::GenerateScene()
{
    ...
    animationStateDance = simbadEnt->getAnimationState("Dance");
    animationStateDance->setLoop(true);
    animationStateDance->setEnabled(true);

    animationStateRunTop = simbadEnt->getAnimationState("RunTop");
    animationStateRunTop->setLoop(true);
    animationStateRunTop->setEnabled(true);

    animationStateRunBase = simbadEnt->getAnimationState("RunBase");
