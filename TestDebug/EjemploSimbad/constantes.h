...
////OgreHead
const Ogre::Vector3 OS_OGREHEAD_DEFAULT_SCAL = {0.15, 0.15, 0.15};
const int OS_OGREHEAD_MED_DEGREES = 90;
const int OS_OGREHEAD_MED_MOV = 62;
const Ogre::Real OS_OGREHEAD_MED_DUR = OS_SIMBAD_STATIC_DUR + OS_SIMBAD_FLIP_DER_DUR + OS_SIMBAD_DER_DUR;

const int OS_OGREHEAD_FLIP_IZQ_DEGREES = -90;
const Ogre::Real OS_OGREHEAD_FLIP_IZQ_DUR = OS_SIMBAD_FLIP_IZQ_DUR;

const int OS_OGREHEAD_IZQ_MOV = 30;
...
const int OS_OGREHEAD_DER2_MOV = 25;
const Ogre::Vector3 OS_OGREHEAD_DER2_SCAL = { 0.01, 0.01, 0.01 };
const Ogre::Real OS_OGREHEAD_DER2_DUR = OS_SIMBAD_DER2_DUR;
