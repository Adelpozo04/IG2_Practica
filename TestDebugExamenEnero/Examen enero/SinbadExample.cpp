...
void SinbadExample::setupScene(void) {
   ...
   // mSinbadNode->showBoundingBox(true);
    ...
    mSM->setSkyPlane(true, plane, "Sky", 1000, 5, true, 3, 200,200);
    ...
    mSS = new SpaceShip({ 0,0,0 }, mSM->getRootSceneNode()->createChildSceneNode(), mSM);
    addInputListener(mSS);

    floorNode->setPosition(mSS->getPosition() - Vector3(0, 450, 0));
    //mSinbadNode->showBoundingBox(true);
}